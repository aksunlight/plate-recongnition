...
class Weather():
        ...
        def __init__(self):
                ...
                self.img = ImageTk.PhotoImage(Image.open('11.png'))
                ...
                self.img2 = ImageTk.PhotoImage(Image.open('11.png'))
                ...
                self.img3 = ImageTk.PhotoImage(Image.open('11.png'))
                ...
                self.img4 = ImageTk.PhotoImage(Image.open('11.png'))
                ...
                self.img5 = ImageTk.PhotoImage(Image.open('11.png'))
